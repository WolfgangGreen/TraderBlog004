...
for trading_date in trading_dates(timestamp('2023-12-01'), timestamp('2024-05-30')):
    # for trading_date in [timestamp('2024-01-22')]:

    print(f"c=hhhl a=trade s=started date={date_string(trading_date)} " +
    ...
    for delta in pd.timedelta_range(start='09:35:00', end='16:00:00', freq='5min'):
        ...
        print(f"c=hhhl a=tradeDuringInterval s=started decisionTime={time_string(decision_time)} " +
        ...
        if time_string(decision_time) <= latest_trade_time:
            ...
            if len(candidates) > 0:
                for candidate in candidates[:max_trades-active_trades]:
                    ...
                    print(f"c=hhhl a=selectTrade d={time_string(decision_time)} "
        ...
        print(f"c=hhhl a=tradeDuringInterval s=completed decisionTime={time_string(decision_time)} "
